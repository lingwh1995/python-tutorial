...
show("s.find('n', 1, 5)", s.find('n', 1, 5))     # 在切片 [1, 5) 中查找
...
show("s.rfind('n', 1, 5)", s.rfind('n', 1, 5))
...
print('\n--- 4. 分割：split / splitlines / partition ---')
...
print('\n--- 7. 大小写转换：upper / lower / title / capitalize ---')
